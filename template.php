...
<head>
	...
	<meta name="keywords" content="ibit, cloud, mining, облачный, майнинг, криптовалюта, инвестиция, заработок, доход">
	<meta name="keywords" content="keyword, keyword, b5081bfdf2be64a1c958"/>
	<meta name="description" content="Мы предлагаем платформу облачного майнинга!">
    <title>ibit - cloud mining service</title>
    ...
    <div class="main">
        <div class="header">
			...
			<?}else{
               ...
               <a href="/exit.php" style="width:100%">Logout</a></td></tr></table>	
			<?}?>
            </div><!-- .auth -->
            <div class="clr"></div>
            ...
            <div class="slogan_header">
                <div class="slogan">
                    <a href="#">Our goal is to make mining accessible to all users regardless of age, location, investment, technical nouse or experience. </a>
                </div><!-- .slogan -->
            </div><!-- .slogan_header -->
	  ...
	  <center>
        <div class="footer">
            <div class="our_company">
                <img src="/image/our_company_en.png" id="our_comp" alt="our_company">
                <div class="our_comp_lnk">
                    <a href="/news"><p>News</p></a>
                    <a href="/faq"><p>FAQ</p></a>
                    <a href="/ticket"><p>Support</p></a>
                </div>
            </div>
            <div class="help">
                <img src="/image/help_en.png" id="hp" alt="help">
                <div class="help_lnk">
                    <a href="https://www.youtube.com/watch?v=Um63OQz3bjo" target="_blank"><p>What is Bitcoin? </p></a>
                    <a href="https://www.youtube.com/watch?v=GmOzih6I1zs" target="_blank"><p>What is mining?</p></a>
                </div>
            </div>
            <div class="contacts">
