...
<table width="650" bgcolor="#eeeeee" align="center" border="0" style="border: solid #cccccc 1px;">
	<tr>
		...
		<td align="right"><input class="inp" style="width: 400px;" type="text" name="name" size="80" maxlength="20" value="<?php print $row['name']; ?>" /></td>
	...
	<tr>
		...
		<td align="right"><input class="inp" style="width: 400px;" type="text" name="purse" size="80" maxlength="50" value="<?php print $row['purse']; ?>" /></td>
	...
	<tr>
		...
		<td align="right"><input class="inp" style="width: 400px;" type="text" name="abr" size="80" maxlength="10" value="<?php print $row['abr']; ?>" /></td>
	...
	<tr>
		...
		<td align="right"><input class="inp" style="width: 400px;" type="text" name="percent" size="80" maxlength="50" value="<?php print $row['percent']; ?>" /></td>
	...
	<tr>
		...
		<td align="right"><input class="inp" style="width: 400px;" type="text" name="comment" size="80" maxlength="250" value="<?php print $row['comment']; ?>" /></td>
