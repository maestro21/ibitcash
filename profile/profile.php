...
if ($login) {
	...
	if ($_GET['action'] == 'save') {
		...
		if($cpass == mysql_result($sql,0,'pass'))
		{
...
<li class="active_l"><a href="/profile/">Profile</a></li>
							</ul>
							<br><br>
							</div>
					 </div>
		...
		<p></p>
		<br>
<input type="email" class="profile" name="email" id="email" value="<?echo $user_mail;?>" placeholder="&nbsp;&nbsp;Your E-MAIL" >
<input type="password" class="profile" name="password" id="password" placeholder="&nbsp;&nbsp;Password" >
<div align="center" style="padding-top: 10px;"><input class="submit pay" type="submit" name="submit" value=" Send " /></div>
</center></div></form>
	<?}else{?>
					 <?
					 if($_GET['ok']==1)
					 ...
					 ?>
					 								<p id="prof_h">Profile</p>
													<p id="prof_h">* - requesting fields</p>
													<p id="prof_h">To save your information you must<br> input your password and press "CHANGE" button.</p>
				<form action="?action=save" method=post id="registration">
						<div class="forms_right">
							<input type="text" disabled value=<?echo $login;?> class="profile" placeholder="&nbsp;&nbsp;Nickname" > <input type="email" class="profile" name="email" id="email" value="<?echo $user_mail;?>" placeholder="&nbsp;&nbsp;E-MAIL" ><br>
							<input type="text" class="profile" name="fio" placeholder="&nbsp;&nbsp;Full name"  value="<?echo $user_fio;?>"> <input type="text" class="profile"  value="<?echo $user_skype;?>" name="skype" placeholder="&nbsp;&nbsp;Skype" ><br>
							<input type="text" class="profile"  value="<?echo $user_phone;?>" name="phone" placeholder="&nbsp;&nbsp;Phone number" > <input type="text"  value="<?echo $user_country;?>" class="profile" name="country" placeholder="&nbsp;&nbsp;Country" ><br>
							<input type="text" class="profile"  value="<?echo $user_town;?>" name="town" placeholder="&nbsp;&nbsp;City" > <input type="text"  value="<?echo $user_site;?>" class="profile" name="site" placeholder="&nbsp;&nbsp;WebSite" ><br>
							<p class="change_pass">Change password</p>
							<input type="password" class="profile" name="pass_1" placeholder="&nbsp;&nbsp;New password" > <input type="password" name="pass_2" class="profile" placeholder="&nbsp;&nbsp;Confirm new password" ><br>
							<input type="password" class="profile" name="cpass" size="20" maxlength="40"  placeholder="&nbsp;&nbsp;Current password*" required class="number"> 
						<span id="buttonBlock" style='margin:0;padding:0;'>
										<button class="submit pay" style="width:41%;font-size:0.7em;margin:0;padding:0;margin-top:1em;" id="checkPayments">CHANGE</button>
									</span></form><br><br><font size=4 color=red></div><br>
									</div>
									</div>
<?php
} }else {
