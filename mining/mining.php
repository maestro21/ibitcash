...
<div style="margin-left:10%;margin-right:10%;">
					  ...
					  <div>
							<ul class="left-menu">
		<li class="active_l"><a href="/mining/">Mining</a></li>
...
<li><a href="/profile/">Profile</a></li>
					 ...
					 <div class="right_div">
						...
						<div class="mining_div"><b>Cloud</b><br>Price:<br><b>Generated:</b><br><br></div> 
						<div class="mining_div"><br><?echo number_format($price_cld,8,',','');?><br><b><span id='cldsum' style="font-size:1em;"><?echo number_format($cur_cld,8,',','');?> </span></b><br><br><br></div> 
						<div class="mining_div btntop"><input id='bcld'type="button" class="submit ming" onclick="curInterval(7,0)" value="MINE" /></div>
						<div style=" width:100%; height:1px; clear:both;"></div> 
					</div>
<div class="mining">
						<div style=" width:100%; height:1px; clear:both;"></div>
						<div class="mining_div"><img src="bitcoin.png" /></div> 
						<div class="mining_div"><b>Bitcoin</b><br>Generated:<br>In a hour:<br>Price:<br><b>Avaliable:</b></div> 
...
if($sbtc==0){
	...
	echo "<span style='font-size:1em;color:#AA3333;'>$".$res1."↓</span>"; 
						...
						<div class="mining_div btntop"><input id='bbtc' type="button" class="submit ming" onclick="curInterval(1,0)" value="MINE" /></div>
						<div style=" width:100%; height:1px; clear:both;"></div> 
					</div>
					...
					<div class="mining">
						...
						<div class="mining_div"><b>Litecoin</b><br>Generated:<br>In a hour:<br>Price:<br><b>Avaliable:</b></div> 
...
?><br><b><span id='ltcplus' style="font-size:1em;"><?echo number_format($cur_ltc,8,',','');?></span></b></div> 
						<div class="mining_div btntop"><input id='bltc' type="button" class="submit ming" onclick="curInterval(3,0)" value="MINE" /></div>
						<div style=" width:100%; height:1px; clear:both;"></div> 
					</div>
					...
					<div class="mining">
						...
						<div class="mining_div"><b>Dogecoin</b><br>Generated:<br>In a hour:<br>Price:<br><b>Avaliable:</b></div> 
...
?><br><b><span id='dgcplus' style="font-size:1em;"><?echo number_format($cur_dgc,8,',','');?></span></b></div> 
						<div class="mining_div btntop"><input id='bdgc' type="button" class="submit ming" onclick="curInterval(2,0)" value="MINE" /></div>
						<div style=" width:100%; height:1px; clear:both;"></div> 
					</div>
					...
					<div class="mining">
						...
						<div class="mining_div"><b>Ripple</b><br>Generated:<br>In a hour:<br>Price:<br><b>Avaliable:</b></div> 
...
?><br><b><span id='dshplus' style="font-size:1em;"><?echo number_format($cur_dsh,8,',','');?></span></b></div> 
						<div class="mining_div btntop"><input id='bdsh' type="button" class="submit ming" onclick="curInterval(4,0)" value="MINE" /></div>
						<div style=" width:100%; height:1px; clear:both;"></div> 
					</div>	
					<div class="mining">
						<div style=" width:100%; height:1px; clear:both;"></div>
						<div class="mining_div"><img src="e.png" /></div> 
						<div class="mining_div"><b>Ethereum</b><br>Generated:<br>In a hour:<br>Price:<br><b>Avaliable:</b></div> 
...
?><br><b><span id='ethplus' style="font-size:1em;"><?echo number_format($cur_eth,8,',','');?></span></b></div> 
						<div class="mining_div btntop"><input id='beth' type="button" class="submit ming" onclick="curInterval(6,0)" value="MINE" /></div>
						<div style=" width:100%; height:1px; clear:both;"></div> 
					</div>
					...
					<div class="mining">
						...
						<div class="mining_div"><b>Bitcoin cash</b></b><br>Generated:<br>In a hour:<br>Price:<br><b>Avaliable:</b></div> 
...
?><br><b><span id='mnrplus' style="font-size:1em;"><?echo number_format($cur_mnr,8,',','');?></span></b></div> 
						<div class="mining_div btntop"><input id='bmnr' type="button" class="submit ming" onclick="curInterval(5,0)" value="MINE" /></div>
						<div style=" width:100%; height:1px; clear:both;"></div> 
					</div>
				</div>
				</div>
