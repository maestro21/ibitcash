...
include '../att_en.php';
if($login) {
	?><center><br><p id="supp_h" style='margin:auto;'>Tech support</p></center><?
if($_GET['new']=='create')
{
?>			<form method=post action='?new=save'>
<div style="margin-left:29%;margin-right:15%;"><br>
							<input type="text" class="theme" name='title' placeholder="&nbsp;&nbsp;Subject"><br>
							<textarea name="text" class="sup_area" placeholder="&nbsp;&nbsp;Describe your problem"></textarea><br>			
							<input type="text" class="inp" name="code" size="20" maxlength="5"  placeholder="&nbsp;&nbsp;CAPTCHA" class="number"/> 
							<img class="capcha" src="../captcha.php" border="0" alt="CAPTCHA" /><br>
							<br><a href="#"><button class="submit sup" name="" type="submit">Submit</button></a>
								</div>	<br><br>
				</form>
...
<BR>
	<BR>
	<center>
<center><form action='?new=send&sid=<?echo $id?>' method=post><a href='?new=close&tid=<?echo $id?>'>The problem is solved, close the ticket</a><br><br>
Send a message:<br><br>							<textarea name="text" class="sup_area" placeholder="&nbsp;&nbsp;Enter your message"></textarea><br>			
							<input type="text" class="inp" name="code" size="20" maxlength="5"  placeholder="&nbsp;&nbsp;CAPTCHA" class="number"/> 
							<img class="capcha" src="../captcha.php" border="0" alt="CAPTCHA" /><br>
							<br><a href="#"><button class="submit sup" name="" type="submit">Submit</button></a><br><br>
...
for($i=0;$i<mysql_num_rows($sql);$i++)
{
	...
	$tid=mysql_result($sql,$i,'id');?>
								...
								<td><?echo $date;?></td>
								<td><b><?
	if($status==0){echo "Open";}else{echo "Closed";}?></b></td>
							</tr><?
	
}
?></table><br><div>
<a href='?new=create' style="text-align:center;">
<button class="submit sup" type=submit>Open a ticket</button>
</a></div><br><br></center>
<?
}
