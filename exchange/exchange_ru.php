...
//<script>val_Prices(<?echo $price_btc;,<?echo $price_dgc;,<?echo $price_ltc;,<?echo $price_dsh;,<?echo $price_mnr;,<?echo $price_eth;,<?echo $price_cld;);</script>
...
<li class="active_l"><a href="/exchange/">Обмен на мощности Cloud</a></li>
...
<li><a href="/profile/">Профиль</a></li>
					 ...
					 <div class="right_div">
									<h1 >Внутренняя система обмена</h1>
				
							<h5><b>При обмене на криптовалюту комиссия - 15%
							<h5><i>Обмен на внутреннюю валюту Cloud осуществляется моментально.</i></h5>
							<br>
							<form action="/exchange/exch.php" method="post" name="drop_down_box">
								<table class="exchange">
									...
									<tr>
										<td>
											<input type="text" id="cur_val" onkeyup="cld_f(this.value)" placeholder="&nbsp Введите суму" class="exchage_text"/>
										</td>
										<td>
											<input type="text" id="cur_cld" placeholder="&nbsp Получите" disabled class="exchage_text"/>
										</td>
									</tr>
									<tr>
									<td colspan=5>
									<input type=button id='be' style='width:25%' value='ОБМЕНЯТЬ' class="exchange_button" onclick="exchange(<?echo $id;?>)">
									</td>
									</tr>
								</table>
								</form>
								<br>
								<h1> История Обмена на Cloud</h1>
								<p>Последние 10 операций</p>
								<div class='his' id='ex'>
					<table class="table_supp" cellpadding="5" style="width:100%;">
					<tr class="table_tr">
						<td class="table_td1" style="width:10%;">Дата</td>
						<td class="table_td1">Отдано</td>
						<td class="table_td1">Обмен</td>
						<td class="table_td1">Получено</td>
					</tr>
				...
				<center><a href='/his_all?t=4'><button class='exchange_button'> Показать всю историю</button></a></center><br>
				</div>
					 </div>
					</div></div>
