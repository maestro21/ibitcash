...
<table class="table_supp" cellpadding="5" style="width:100%;">
					<tr class="table_tr">
						<td class="table_td1" style="width:10%;">Тема</td>
						<td class="table_td1">Дата</td>
					</tr>
<?
...
<table class="table_supp" cellpadding="5" style="width:100%;">
					<tr class="table_tr">
						...
						<td class="table_td1">Дата отправки:<?echo date("d.m.y H:i", $date);?></td>
									...
									<h2><?echo mysql_result($sql,0,'theme');?></h2><br><p><?echo mysql_result($sql,0,'body');?></p><br><br><a href='/mail'>Назад</a><br><br>
